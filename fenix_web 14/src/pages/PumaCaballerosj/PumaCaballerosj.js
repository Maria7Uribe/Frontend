...
function PumaCaballerosj() {
    ...
    const exportToExcel = () => {
        ...
        saveAs(data, 'ProductosPumaCaballeros.xlsx');
    };
    ...
    const exportToPDF = () => {
        ...
        doc.text("Productos Puma Caballeros", 14, 15);
        doc.autoTable({
            head: [tableColumn],
            body: tableRows,
            startY: 20,
        ...
        doc.save('ProductosPumaCaballeros.pdf');
    };
...
export default PumaCaballerosj;
