...
{mostrarFormularioEdicion && (
    <form onSubmit={handleActualizarProducto}>
        <div className="mb-3">
            ...
            <input type="text" className="form-control" id="modeloEdit" name="Modelo_producto" value={productoEditando.Modelo_producto} onChange={handleChange} />
        </div>
        <div className="mb-3">
            <label htmlFor="tipoEdit" className="form-label">Tipo:</label>
            <input type="text" className="form-control" id="tipoEdit" name="Tipo_producto" value={productoEditando.Tipo_producto} onChange={handleChange} />
        </div>
        <div className="mb-3">
            <label htmlFor="colorEdit" className="form-label">Color:</label>
            <input type="text" className="form-control" id="colorEdit" name="Color_producto" value={productoEditando.Color_producto} onChange={handleChange} />
        </div>
        <div className="mb-3">
            <label htmlFor="precioEdit" className="form-label">Precio:</label>
            <input type="text" className="form-control" id="precioEdit" name="Precio_producto" value={productoEditando.Precio_producto} onChange={handleChange} />
        </div>
        <div className="mb-3">
            <label htmlFor="tallaEdit" className="form-label">Talla Disponible:</label>
            <input type="text" className="form-control" id="tallaEdit" name="Talla_disponible_producto" value={productoEditando.Talla_disponible_producto} onChange={handleChange} />
        </div>
        <div className="mb-3">
            <label htmlFor="cantidadEdit" className="form-label">Cantidad Disponible:</label>
            <input type="text" className="form-control" id="cantidadEdit" name="Cantidad_disponible_producto" value={productoEditando.Cantidad_disponible_producto} onChange={handleChange} />
        </div>
        <button type="submit" className="btn btn-primary">Actualizar Producto</button>
        
        {/* Botón para cancelar la edición */}
        <button type="button" className="btn btn-danger" onClick={toggleFormularioEdicion}>Cancelar</button>
    </form>
)}
