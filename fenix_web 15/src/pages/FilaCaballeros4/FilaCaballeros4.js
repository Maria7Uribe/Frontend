    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px' }}>
        <div style={{ marginRight: '60px', width: '800px' }}>
          ...
          >
            <div>
              <img src="../img/caballeros/Fila/Tarjeta 4/lado 1.png"  alt="Imagen 1" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/Fila/Tarjeta 4/lado 2.png" alt="Imagen 2" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/Fila/Tarjeta 4/lado 3.png" alt="Imagen 3" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
          </Carousel>
        </div>
        <div className="details">
          ...
          <div style={{ marginTop: '20px', cursor: 'pointer' }} onClick={handleDescriptionToggle}>
            ...
            {isDescriptionExpanded && (
              <p>Elaborado en materiales de alta calidad permitiendo una mayor perdurabilidad y dando una sensación de confort. Cuenta con un diseño deportivo, el cual agrega cuello, lengüeta y plantilla acolchada. Igualmente, el recubrimiento interno es de una sensación suave al tacto, garantizando su comodidad. </p>
            )}
          </div>
