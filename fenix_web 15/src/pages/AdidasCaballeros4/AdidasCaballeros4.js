...
const AdidasCaballeros4= () => {
  ...
  const [price, setPrice] = useState(200.000); // Precio inicial
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px' }}>
        <div style={{ marginRight: '60px', width: '800px' }}>
          ...
          >
            <div>
              <img src="../img/caballeros/adidas/Tarjeta 4/lado 1.png"  alt="Imagen 1" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/adidas/Tarjeta 4/lado 2 .png" alt="Imagen 2" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/adidas/Tarjeta 4/lado 3.png" alt="Imagen 3" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/adidas/Tarjeta 4/lado 4.png"alt="Imagen 4" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
          </Carousel>
        </div>
        <div className="details">
          ...
          <div style={{ marginTop: '20px', cursor: 'pointer' }} onClick={handleDescriptionToggle}>
            ...
            {isDescriptionExpanded && (
              <p>Estos tenis adidas lucen un exterior de cuero sintético perforado con las 3 Rayas para un look sutil. En el interior, la plantilla Cloudfoam Comfort es ultrasuave y cómoda, absorbiendo el impacto y manteniendo una pisada suave.  </p>
            )}
          </div>
