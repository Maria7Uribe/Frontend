    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px' }}>
        <div style={{ marginRight: '60px', width: '800px' }}>
          ...
          >
            <div>
              <img src="../img/caballeros/Fila/Tarjeta 3/lado 1.png"  alt="Imagen 1" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/Fila/Tarjeta 3/lado 2.png" alt="Imagen 2" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/Fila/Tarjeta 3/lado 3 .png" alt="Imagen 3" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
          </Carousel>
        </div>
        <div className="details">
          ...
          <div style={{ marginTop: '20px', cursor: 'pointer' }} onClick={handleDescriptionToggle}>
            ...
            {isDescriptionExpanded && (
              <p>un estilo clásico pero en tendencia, cuena con una capellada elaborada en material textil que le aporta mas flexibilidad a la hora de practicar deporte y tiene detalles en material sintético en el area del talón</p>
            )}
          </div>
