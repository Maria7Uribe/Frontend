    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '50px' }}>
        <div style={{ marginRight: '60px', width: '800px' }}>
          ...
          >
            <div>
              <img src="../img/caballeros/Jordan/Tarjeta 2/lado 1.png"  alt="Imagen 1" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/Jordan/Tarjeta 2/lado 2.png" alt="Imagen 2" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
            <div>
              <img src="../img/caballeros/Jordan/Tarjeta 2/lado 3.png" alt="Imagen 3" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
          </Carousel>
        </div>
        <div className="details">
          ...
          <div style={{ marginTop: '20px', cursor: 'pointer' }} onClick={handleDescriptionToggle}>
            ...
            {isDescriptionExpanded && (
              <p>Este nuevo estilo de jordan trae comodidad estilo y gran durabilidad, Atrevete con los nuecos tennis jordan </p>
            )}
          </div>
