      ...
      <div className="content">
        <div className="carousel-container">
          ...
          >
            ...
            <div>
              <img src="../img/damas/jordan/Bright Citrus Bright/arriba.jpeg" alt="Imagen 2" className="carousel-image" />
            </div>
            <div>
              <img src="../img/damas/jordan/ CitruBrights Bright/atras.jpeg" alt="Imagen 3" className="carousel-image" />
            </div>
