  ...
  return (
    <div>
      ...
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/nike/DUNK LOW PRO SB 'TWEED/abajo.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/nike/DUNK LOW PRO SB 'TWEED/lado derecho.jpeg" style={imageStyle} />
          <img src="../img/damas/nike/DUNK LOW PRO SB 'TWEED/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Es una zapatilla elegante y moderna de Nike. Con un color marrón clásico y un diseño de perfil bajo, este zapato combina comodidad y moda sin esfuerzo.</p>
          </div>
        </div>
      </div>
