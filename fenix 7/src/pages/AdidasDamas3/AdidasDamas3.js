...
const Adidasdamas3 = () => {
  return (
    <div>
      ...
      <h1>ADDIDAS DREKTAC DAMA</h1>
      <div style={centeredText}>
        <p>ADDIDAS DREKTAC DAMA</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/adidas/adidas hzywanshi/desde arriba.jpeg" alt="Adidas Forum 84 Low Rose Mujer" style={imageStyle} />
          <img src="../img/damas/adidas/adidas hzywanshi/lado derecho.jpeg" style={imageStyle} />
          <img src="../img/damas/adidas/adidas hzywanshi/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Diseñadas para potenciar su estabilidad natural, las zapatillas de running adidas SOLARGLIDE® 4 ST llegan para brindarte más soporte y armonía en tus prácticas diarias.</p>
          </div>
        </div>
      </div>
