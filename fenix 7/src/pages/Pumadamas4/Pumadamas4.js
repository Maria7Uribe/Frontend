...
const Pumadamas4 = () => {
  return (
    <div>
      ...
      <h1>zapatillas puma carina</h1>
      <div style={centeredText}>
        <p>zapatillas puma carina</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/puma/zapatillas puma carina/hacia atras.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/puma/zapatillas puma carina/lado derecho.jpeg" style={imageStyle} />
          <img src="../img/damas/puma/zapatillas puma carina/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>El diseño inspirado en la calle y una plataforma ligeramente elevada hacen que estos Carina sean perfectos para los atuendos cotidianos.
