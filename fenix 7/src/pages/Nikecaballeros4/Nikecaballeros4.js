...
const Nikecaballeros4 = () => {
  return (
    <div>
      ...
      <h1>Nike SB Dunk Low Championship Court Purple White DD1391-104</h1>
      <div style={centeredText}>
        <p>Nike SB Dunk Low Championship Court Purple White DD1391-104</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/nike/Nike SB Dunk Low Championship Court Purple White DD1391-104/abajo.png" alt="" style={imageStyle} />
          <img src="../img/caballeros/nike/Nike SB Dunk Low Championship Court Purple White DD1391-104/arriba.png" style={imageStyle} />
          <img src="../img/caballeros/nike/Nike SB Dunk Low Championship Court Purple White DD1391-104/lado derecho.png" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>🏙️ Estilo Urbano: Perfectas para la moda urbana 🩰 Ajuste personalizado:El sistema de cordones te permite ajustar el calce de las zapatillas para un soporte perfecto.</p>
          </div>
        </div>
      </div>
