  ...
  return (
    <div>
      ...
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/nike/Nike mens Retro/abajo.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/nike/Nike mens Retro/atras.jpeg" style={imageStyle} />
          <img src="../img/damas/nike/Nike mens Retro/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Es un color versátil, blanco y gris del zapato casual de estilo de vida que se lanzó en marzo de 2022. La base de la parte superior está diseñada en piel Pure Platinum, mientras que el cuero gris lobo en contraste aparece en las superposiciones</p>
          </div>
        </div>
      </div>
