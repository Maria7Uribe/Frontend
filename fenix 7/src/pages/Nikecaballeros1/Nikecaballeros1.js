...
const Nikecaballeros1 = () => {
  return (
    <div>
      ...
      <h1>Nike Air Max 96 II “WhiteBlack” Shok Absorbing Running Shoes Casual Sneakers for Men Wome</h1>
      <div style={centeredText}>
        <p>Nike Air Max 96 II “WhiteBlack” Shok Absorbing Running Shoes Casual Sneakers for Men Wome</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/nike/Nike Air Max 96 II “WhiteBlack” Shok Absorbing Running Shoes Casual Sneakers for Men Wome/abajo.jpeg" alt="" style={imageStyle} />
          <img src="../img/caballeros/nike/Nike Air Max 96 II “WhiteBlack” Shok Absorbing Running Shoes Casual Sneakers for Men Wome/arriba.jpeg" style={imageStyle} />
          <img src="../img/caballeros/nike/Nike Air Max 96 II “WhiteBlack” Shok Absorbing Running Shoes Casual Sneakers for Men Wome/atras.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Amortiguación de Alto Rendimiento: Equipadas con la legendaria tecnología Air Max de Nike, estas zapatillas ofrecen una amortiguación reactiva y un soporte excepcional en cada paso. Te sentirás como si estuvieras corriendo sobre nubes.</p>
          </div>
        </div>
      </div>
