  ...
  return (
    <div>
      ...
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/fila/Fila Ray Tracer - Zapatillas de deporte para niño, color gris/abajo.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/fila/Fila Ray Tracer - Zapatillas de deporte para niño, color gris/al lado derecho.jpg" style={imageStyle} />
          <img src="../img/damas/fila/Fila Ray Tracer - Zapatillas de deporte para niño, color gris/ariiba(1).jpg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>El FILA Ray Tracer se vuelve más audaz con un gran gráfico de logotipo FILA duplicado en la parte superior y está de vuelta en combinaciones de colores adicionales, combinando el diseño retro con los estilos Chunky más modernos de la actualidad.</p>
          </div>
        </div>
      </div>
