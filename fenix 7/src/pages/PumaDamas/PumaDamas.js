...
import './PumaDamas.css'; // Importa el archivo CSS
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <a href="Pumadamas1" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
            <br />
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <h5>227</h5>
                  <p className="card-text" />
                  <a href="Pumadamas2" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
            <br />
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <h5>228</h5>
                  <p className="card-text" />
                  <a href="Pumadamas3" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
            <br />
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <h5>229</h5>
                  <p className="card-text" />
                  <a href="Pumadamas4" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
          </div>
