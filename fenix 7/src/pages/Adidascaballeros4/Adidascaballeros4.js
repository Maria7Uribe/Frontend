  ...
  return (
    <div>
      ...
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/adidas/BOTAS FORUM MID/abajo.png" alt="" style={imageStyle} />
          <img src="../img/caballeros/adidas/BOTAS FORUM MID/frontal.png" style={imageStyle} />
          <img src="../img/caballeros/adidas/BOTAS FORUM MID/lado derecho.png" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>🏞️ Diseño Duradero: Las Botas Forum Mid 👢 Comodidad en Cada Paso: La plantilla y acolchada</p>
          </div>
        </div>
      </div>
