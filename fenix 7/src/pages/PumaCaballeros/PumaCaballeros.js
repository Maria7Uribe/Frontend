...
import './PumaCaballeros.css'; // Importa el archivo CSS

function PumaCaballeros() {
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <a href="PumaCaballeros1" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
            <br />
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <h5>126</h5>
                  <p className="card-text" />
                  <a href="PumaCaballeros2" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
            {/* Tarjeta 3 */}
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <h5>127</h5>
                  <p className="card-text" />
                  <a href="PumaCaballeros3" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
            <br />
            ...
            <div className="col-sm-6 mb-3 mb-sm-0">
              <div className="card">
                <div className="card-body">
                  ...
                  <h5>128</h5>
                  <p className="card-text" />
                  <a href="PumaCaballeros4" className="btn btn-primary">ver detalles</a>
                </div>
              </div>
            </div>
          </div>
