...
const Nikedamas2 = () => {
  return (
    <div>
      ...
      <h1>Nike Air Force 1 Low Utility</h1>
      <div style={centeredText}>
        <p>Nike Air Force 1 Low Utility</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/nike/Nike Air Force 1 Low Utility/alfrente.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/nike/Nike Air Force 1 Low Utility/atras.jpeg" style={imageStyle} />
          <img src="../img/damas/nike/Nike Air Force 1 Low Utility/lado derecho.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Una leyenda viviente, que nunca pasa de moda</p>
          </div>
        </div>
      </div>
