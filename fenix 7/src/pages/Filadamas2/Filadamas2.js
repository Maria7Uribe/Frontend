...
const Filadamas2 = () => {
  return (
    <div>
      ...
      <h1>Tenis Lifestyle Rosado-Blanco- Azul Fila Euskadi</h1>
      <div style={centeredText}>
        <p>Tenis Lifestyle Rosado-Blanco- Azul Fila Euskadi</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/fila/Fila Mujer Réplica AAA/frontal.png" alt="" style={imageStyle} />
          <img src="../img/damas/fila/Fila Mujer Réplica AAA/lado derecho.png" style={imageStyle} />
          <img src="../img/damas/fila/Fila Mujer Réplica AAA/lado izquierdo.png" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Una silueta casual y femenina que mezcla materiales para crear un efecto dinámico y versátil en nuestros tenis. Su suela es en EVA y plantilla en espuma cómoda. Ideales para uso cotidiano, ajuste clásico de cordones, con cintas en los laterales que le dan un aire retro al diseño con terminaciones finamente reforzadas.</p>
          </div>
        </div>
      </div>
