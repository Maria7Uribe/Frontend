...
function Editar() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Verificar si algún campo editable está vacío
        const camposVacios = Object.keys(usuarioSeleccionado).some(key => camposEditables[key] && !usuarioSeleccionado[key]);
        ...
        try {
            ...
            setUsuarios(prevUsuarios =>
                prevUsuarios.map(usuario =>
                    usuario.Id_usuario === usuarioSeleccionado.Id_usuario ? usuarioSeleccionado : usuario
                )
            );
