...
import PumaCaballeros1 from './pages/PumaCaballeros1/PumaCaballeros1';
import PumaCaballeros2 from './pages/PumaCaballeros2/PumaCaballeros2';
import PumaCaballeros3 from './pages/PumaCaballeros3/PumaCaballeros3';
import PumaCaballeros4 from './pages/PumaCaballeros4/PumaCaballeros4';
import PumaDamas1 from './pages/PumaDamas1/PumaDamas1';
import PumaDamas2 from './pages/PumaDamas2/PumaDamas2';
import PumaDamas3 from './pages/PumaDamas3/PumaDamas3';
import PumaDamas4 from './pages/PumaDamas4/PumaDamas4';
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/pumacaballeros1" element={<PumaCaballeros1 />} />
                <Route path="/pumacaballeros2" element={<PumaCaballeros2 />} />
                <Route path="/pumacaballeros3" element={<PumaCaballeros3 />} />
                <Route path="/pumacaballeros4" element={<PumaCaballeros4 />} />
                <Route path="/pumadamas1" element={<PumaDamas1 />} />
                <Route path="/pumadamas2" element={<PumaDamas2 />} />
                <Route path="/pumadamas3" element={<PumaDamas3 />} />
                <Route path="/pumadamas4" element={<PumaDamas4 />} />
            </Routes>
        </Router>
    );
}
