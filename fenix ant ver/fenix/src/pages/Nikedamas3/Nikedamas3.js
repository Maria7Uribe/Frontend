...
const Nikedamas3 = () => {
  return (
    <div>
      ...
      <h1>Tenis Blanco-Morado-Verde Nike Air Max 90 Essential</h1>
      <div style={centeredText}>
        <p>Tenis Blanco-Morado-Verde Nike Air Max 90 Essential</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/nike/Nike Air Max 90 Essential AJ1285-103 zapatillas/arriba.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/nike/Nike Air Max 90 Essential AJ1285-103 zapatillas/atras.jpeg" style={imageStyle} />
          <img src="../img/damas/nike/Nike Air Max 90 Essential AJ1285-103 zapatillas/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Siente una ligereza increíble con el sistema Nike Air. Todo gracias al cojín amortiguador con aire comprimido ubicado en la suela.</p>
          </div>
        </div>
      </div>
