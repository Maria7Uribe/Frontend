...
const Adidasdamas4 = () => {
  return (
    <div>
      ...
      <h1>Adidas PureBoost 21 Black White</h1>
      <div style={centeredText}>
        <p>Adidas PureBoost 21 Black White</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/adidas/Adidas Unisex-Adult Pureboost 22 Running Shoe/atras.jpeg" alt="Adidas Forum 84 Low Rose Mujer" style={imageStyle} />
          <img src="../img/damas/adidas/Adidas Unisex-Adult Pureboost 22 Running Shoe/lado derecho.jpeg" style={imageStyle} />
          <img src="../img/damas/adidas/Adidas Unisex-Adult Pureboost 22 Running Shoe/lado izquierdo.jpeg" style={imageStyle} />
        </div>
