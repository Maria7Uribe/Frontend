...
import './Inventariojefeprincipal.css';

function Inventariojefeprincipal() {
    ...
    return (
        <div>
            <div>
                ...
                <title>Inventario Jefe Principal</title>
                                ...
                                <div className="col-md-2">
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title">NIKE</h5>
                                            <p className="card-text">"Solo hazlo"</p>
                                            <Link to="/nikecaballeros" className="btn btn-primary">Ver zapatillas</Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-2">
...
export default Inventariojefeprincipal;
