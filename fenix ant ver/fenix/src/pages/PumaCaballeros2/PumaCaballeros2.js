...
const PumaCaballeros2 = () => {
  return (
    <div>
      ...
      <h1>Zapatillas de training Disperse XT 3</h1>
      <div style={centeredText}>
        <p>Zapatillas de training Disperse XT 3</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/puma/Zapatillas de training Disperse XT 3/alfrente.jpeg" alt="" style={imageStyle} />
          <img src="../img/caballeros/puma/Zapatillas de training Disperse XT 3/lado derecho.jpg" style={imageStyle} />
          <img src="../img/caballeros/puma/Zapatillas de training Disperse XT 3/lado izquierdo.jpg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Continúa esforzándote y sube el nivel de tus entrenamientos con las zapatillas de training de próxima generación Disperse XT 3, la última incorporación a una línea situada entre el rendimiento y el diseño. Esta nueva versión de los modelos anteriores presenta zonas de goma que aumentan la tracción y el control combinadas con los materiales ultraligeros de siempre para ofrecerte una agilidad máxima.</p>
          </div>
        </div>
      </div>
...
export default PumaCaballeros2;
