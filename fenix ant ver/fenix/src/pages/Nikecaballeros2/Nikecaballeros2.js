...
const Nikecaballeros2 = () => {
  return (
    <div>
      ...
      <h1>Nike Dunk Low WMNS DD1503 100 Coast</h1>
      <div style={centeredText}>
        <p>Nike Dunk Low WMNS DD1503 100 Coast</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/nike/Nike Dunk Low WMNS DD1503 100 Coast/abajo (2).png" alt="" style={imageStyle} />
          <img src="../img/caballeros/nike/Nike Dunk Low WMNS DD1503 100 Coast/arriba.png" style={imageStyle} />
          <img src="../img/caballeros/nike/Nike Dunk Low WMNS DD1503 100 Coast/lado izquierdo.png" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Diseño Inspirado en la Costa: El color "Coast" captura la frescura y la serenidad del océano, lo que hace que estas zapatillas sean ideales para los amantes del estilo costero.</p>
          </div>
        </div>
      </div>
