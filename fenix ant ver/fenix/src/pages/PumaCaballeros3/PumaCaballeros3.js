...
const PumaCaballeros3 = () => {
  return (
    <div>
      ...
      <h1>PUMA Tenis anchos Rebound Layup para hombre</h1>
      <div style={centeredText}>
        <p>PUMA Tenis anchos Rebound Layup para hombre</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/puma/PUMA Tenis anchos Rebound Layup para hombre/abajo.png" alt="" style={imageStyle} />
          <img src="../img/caballeros/puma/PUMA Tenis anchos Rebound Layup para hombre/lado derecho.png" style={imageStyle} />
          <img src="../img/caballeros/puma/PUMA Tenis anchos Rebound Layup para hombre/lado izquierdo.png" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Los tenis anchos PUMA Rebound Layup para hombre son una excelente combinación de estilo y comodidad diseñada para satisfacer las necesidades de aquellos con pies más anchos. Estos tenis presentan un diseño moderno y deportivo, perfecto para quienes buscan un look atlético y a la moda. La parte superior está confeccionada con materiales de alta calidad, proporcionando durabilidad y soporte durante toda la jornada. El ajuste ancho garantiza un espacio adicional para los pies, evitando cualquier sensación de apretamiento o incomodidad. La suela de caucho ofrece una tracción óptima en diversas superficies, asegurando una pisada firme y segura. Estos tenis son ideales para actividades diarias y sesiones de entrenamiento, brindando estilo y confort en cada paso</p>
          </div>
        </div>
      </div>
...
export default PumaCaballeros3;
