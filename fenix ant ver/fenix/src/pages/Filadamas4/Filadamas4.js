  ...
  return (
    <div>
      ...
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/fila/fila run 1 blue/abajo.jpeg" alt="" style={imageStyle} />
          <img src="../img/damas/fila/fila run 1 blue/arriba.jpeg" style={imageStyle} />
          <img src="../img/damas/fila/fila run 1 blue/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>combinan una parte superior de piel y malla con una mediasuela de Phylon para ofrecer una comodidad y estabilidad duraderas. La suela exterior GDR proporciona una tracción duradera sobre superficies de pista rápida.
