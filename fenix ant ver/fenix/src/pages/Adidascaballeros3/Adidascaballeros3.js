...
const Adidascaballeros3 = () => {
  return (
    <div>
      ...
      <h1>adidas neo Grand Court Grey Three</h1>
      <div style={centeredText}>
        <p>adidas neo Grand Court Grey Three</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/adidas/adidas neo Grand Court '' Grey Three/abajo.png" alt="" style={imageStyle} />
          <img src="../img/caballeros/adidas/adidas neo Grand Court '' Grey Three/frontal.png" style={imageStyle} />
          <img src="../img/caballeros/adidas/adidas neo Grand Court '' Grey Three/lado derecho.png" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>🟡 Diseño Elegante: El color gris suave de las Adidas Neo Grand Court Grey Three se combina con detalles en blanco, creando un diseño limpio y cómodo que complementa tu estilo.</p>
          </div>
        </div>
      </div>
