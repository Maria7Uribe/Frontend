...
const Pumadamas3 = () => {
  return (
    <div>
      ...
      <h1>Puma Women's Free time and Sportwear</h1>
      <div style={centeredText}>
        <p>Puma Women's Free time and Sportwear</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/damas/puma/Puma Women's Free time and Sportwear/abajo.jpg" alt="" style={imageStyle} />
          <img src="../img/damas/puma/Puma Women's Free time and Sportwear/atrass.jpg" style={imageStyle} />
          <img src="../img/damas/puma/Puma Women's Free time and Sportwear/lado derecho.jpg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>se inspira en los autos antiguos con diseños divertidos.Estos tenis toman su nombre de la histórica Ruta de la Seda que conecta el este con el oeste. Recorre todos los caminos imaginables con tus zapatillas Puma Cruise Rider Silk Road.</p>
          </div>
        </div>
      </div>
