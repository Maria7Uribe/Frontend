    ...
    function FilaCaballerosB() {
        ...
        const handleEdit = (producto) => {
            ...
            setNuevoProducto({
                PK_fk_Id_marca_producto: producto.PK_fk_Id_marca_producto,
                Modelo_producto: producto.Modelo_producto,
                Tipo_producto: producto.Tipo_producto,
                Color_producto: producto.Color_producto,
                Precio_producto: producto.Precio_producto,
                Talla_disponible_producto: producto.Talla_disponible_producto,
                Cantidad_disponible_producto: producto.Cantidad_disponible_producto
            });
                    ...
                    {mostrarFormulario && !mostrarFormularioEditar && (
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="d-flex">
                                <button type="submit" className="btn btn-primary me-2">Agregar Producto</button>
                                {mostrarFormulario && (
