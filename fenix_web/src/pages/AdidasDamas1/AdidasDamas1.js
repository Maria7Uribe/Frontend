...
const Adidasdamas1 = () => {
  return (
    <div>
      ...
      <h1>Página Adidasdamas1</h1>
      <div style={centeredText}>
        <p>Sport line Adidas Forum 84 Low Rose Mujer Réplica AAA</p>
      </div>
      <div style={additionalInfoContainer}>
      </div>
      <div style={imageContainer}>
        <div>
          <img src="../img/caballeros/adidas/adidas beyaz erkek spr ayakkab/hacia abajo.jpeg" alt="" style={imageStyle} />
          <img src="../img/caballeros/adidas/adidas beyaz erkek spr ayakkab/lado derecho frontal.jpeg" style={imageStyle} />
          <img src="../img/caballeros/adidas/adidas beyaz erkek spr ayakkab/lado izquierdo.jpeg" style={imageStyle} />
        </div>
        <div style={textBesideImage}>
          ...
          <div>
            <h2>Descripción</h2>
            <p>Las Adidas Forum con tonalidad rosa son unas zapatillas femeninas de estilo retro que hacen homenaje a los diseños de los 80.</p>
          </div>
        </div>
      </div>
